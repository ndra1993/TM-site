     ...
     <?php } ?>
        ...
        <div class="moreCasestudy">
            <div class="brandLogos">
                <div class="relatedBox relatedBoxone" style="background:<?php echo get_sub_field('brandlogosone'); ?>">
                    <a href="#"><img src="<?php echo get_sub_field('image_1'); ?>"></a>
                </div>
                <div class="relatedBox relatedBoxtwo" style="background:<?php echo get_sub_field('brandlogostwo'); ?>">
