<?php get_header(); /*Template Name: case studies listing 1*/
...
<style>
    ...
    .slick-vertical .slick-slide .show-workItem {
      ...
      <div class="caseStudyFilter">
       ...
       <!--   <li class="filterLi active"><span class="filter font12 fontW500" data-filter=".experience, .technology, .marketing, .branding, .video, .strategy">All</span></li>
          ...
          -->
           ...
           <li class="filterLi"><span class="works-filter filter font12 fontw500 showAll">All</span></li>
                    <?php
                    ...
                    ?>
                     ...
                     <li class="filterLi"><span class="works-filter filter font12 fontW500" data-filter="<?php echo $termslug ?>"><?php echo $termname ?></span></li>
    ...
    <?php 
    $groupID = 'case_study';
        $custom_query_args = array('post_type' => 'case_study1','posts_per_page' => 9,'order' => 'DESC','post_status' => 'publish');
    ...
    $custom_query = new WP_Query( $custom_query_args );
                        ...
                        <div class="img-holder workItem show-workItem <?php foreach((get_the_category()) as $category) {   $cat_name = strtolower($category->cat_name) . '';  echo str_replace(' ','-',$cat_name);}?>">
    ...
    $custom_query = new WP_Query( $custom_query_args );
          ...
          <div class="workItem content-item show-workItem <?php foreach((get_the_category()) as $category) {   $cat_name = strtolower($category->cat_name) . '';  echo str_replace(' ','-',$cat_name);} ?>">
    ...
    <?php $text = str_replace('<p>','', the_content());
    echo $text = str_replace('</p>','',$text); ?>
                               </h2>
                            </div>
                            </a>
                        </div>
    ...
    */
    ...
    jQuery(document).ready(function(){
     ...
     $(document).ready(function () {
      $('div.slick-slide').attr('style', 'display: block !important;');
      $('div.img-holder').attr('style', 'display: block !important;');
    });
    </script>