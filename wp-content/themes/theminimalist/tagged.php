<?php get_header(); /*Template Name: tagged*/
?>
...
<div class="taggedbgdetails">
    ...
    <section>
        <div class="sectionTwo">
            ...
            <div class="mobimgTwo wow slideInRight" data-wow-duration="1s">
                <img src="<?php bloginfo('template_directory'); ?>/images/tagged-banner-2.png">
            </div>
        </div>
    </section>
    <section>
    ...
    <section>
        <div class="sectionFour">
            <div class="desktopImg">
                <img src="<?php bloginfo('template_directory'); ?>/images/tagged-1.png">
            </div>
            <div class="mobileImg">
                <img src="<?php bloginfo('template_directory'); ?>/images/tagged-1.png">
    ...
    <section class="sectionSix">
        <div class="sectionSiximg"><img src="<?php bloginfo('template_directory'); ?>/images/tagged-2.png"></div>
