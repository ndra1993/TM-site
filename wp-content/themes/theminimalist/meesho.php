...
<div class="csdetailBg" style="background: linear-gradient(158.47deg, #070707 4.94%, #101010 53.55%, #070707 58.48%, #020202 65.02%, #131313 77.34%);">
    <!-- Banner Section -->
    <section class="bannerSection taggedBanner" style="background: linear-gradient(158.47deg, #070707 4.94%, #101010 53.55%, #070707 58.48%, #020202 65.02%, #131313 77.34%);">
    ...
    <!-- <section>
        <div class="meeshobg sectionOne">
            ...
            <div class="wow fadeInDown mobImg" data-wow-duration="4s">
                <img src="<?php bloginfo('template_directory'); ?>/images/meesho-banner.svg">
            </div>
        </div>
    </section> -->
    ...
    <section>
        <div class="sectionFourMeesho">
            <div class="desktopImg">
                <img src="<?php bloginfo('template_directory'); ?>/images/meesho-footer.png">
            </div>
        </div>
    </section>
    <!-- leftheading-rightText -->
